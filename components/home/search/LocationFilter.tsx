...
export default function Location({title,dropDownOpened, setDropDownOpened}:filterProps){
    const handleClick = () =>{
    ...
    return(
        <div dir="ltr" className="relative flex flex-col">
            ...
            <div className="absolute top-full right-0">
                {(dropDownOpened === title) && <DropDownMenu title="الموقع" action={<button onClick={()=> {}} className="hover:underline text-xs">اعادة الضبط</button>}>
