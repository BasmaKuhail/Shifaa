    ...
    return(
        <div className='w-full flex flex-col overflow-x-hidden '>
            <div className="bg-blue-100 relative inline-block pb-100">
                ...
                <div className="flex flex-col items-center justify-cneter mt-30 gap-7">
                    <div className="flex flex-col gap-1 w-full items-center">
                        <Title  title="البحث عن الدواء" bgColor="white"/>
                        <div className="flex flex-row gap-3 items-center justify-between w-full lg:w-[40%] md:w-[50%]">
                            <Image src={leftBubble} alt=""/>
                            <HeaderText text="هل أنت مستعد للبحث؟" color="black"/>
                            <Image src={rightBubble} alt=""/>
                        </div>
                    </div>
                    <p className="text-center text-btn font-[500] w-full lg:w-[40%]">لا تدع البحث عن الدواء يستنزف وقتك وطاقتك. ابدأ بحثك الآن لتجد أقرب صيدلية توفر الدواء الذي تحتاجه بضغطة زر واحدة.</p>
                    <div className="h-[45px]"><GradientBrn text="ابحث الان" onClick={() => {}} px={20}/></div>
                </div>
                <div className="flex flex-col items-center justify-cneter mt-30 gap-7 md:px-10 lg:px-30 xl:px-50 ">
                    <div className="flex flex-col gap-1 w-full items-center">
